...
package com.lewy3d.game.Core.Environment.Terrain.mundus.commons.scene3d.components;
...
public class TerrainComponent extends AbstractComponent {
    ...
    public void render(float delta) {
        GameWorld.modelBatch.render(terrain.getTerrain(), gameObject.sceneGraph.scene.environment, shader);
    }
