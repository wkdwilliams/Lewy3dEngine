...
package com.lewy3d.game.Core.Environment.Terrain.mundus.commons.utils;
...
public class ShaderUtils {
    ...
    public static ShaderProgram compile(String vertexShader, String fragmentShader) {
        ...
        //if (Gdx.app.getType() == Application.ApplicationType.WebGL) {
            vert = Gdx.files.internal("core/mundus/model.vert.glsl").readString();
            frag = Gdx.files.internal("core/mundus/model.frag.glsl").readString();
        /*} else {
