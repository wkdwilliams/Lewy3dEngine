...
public class ModelShader extends BaseShader {
    ...
    private static final String VERTEX_SHADER = "com.lewy3d.game.Core.Environment.Terrain.mundus.commons.shaders/model.vert.glsl";
    private static final String FRAGMENT_SHADER = "com.lewy3d.game.Core.Environment.Terrain.mundus.commons.shaders/model.frag.glsl";
