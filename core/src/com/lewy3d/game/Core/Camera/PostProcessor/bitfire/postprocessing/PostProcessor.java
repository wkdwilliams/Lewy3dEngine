...
package com.lewy3d.game.Core.Camera.PostProcessor.bitfire.postprocessing;
...
import com.lewy3d.game.Core.Camera.PostProcessor.bitfire.utils.ItemsManager;
...
public final class PostProcessor implements Disposable {
	...
	public void applyProfile(PostProcessingProfile profile){
		for(PostProcessorEffect p : profile.getEffects()){
			addEffect(p);
		}
	}
